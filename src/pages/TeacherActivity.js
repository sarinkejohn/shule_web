...
import { FcSettings, FcContacts,FcMoneyTransfer,FcSportsMode,FcSms,FcPrevious } from 'react-icons/fc';
...
function Polls() {
  ...
  return (
    <div className="polls -mt-3 flex transition duration-700 
     hover:text-blue-500 hover:bg-gray-300"  onClick={() => {
      navigate("/thetalk");
    }}>
...
function TeacherTalk() {
  let navigate = useNavigate();
  return (
    <div className="talk transition duration-700 hover:text-pink-500
